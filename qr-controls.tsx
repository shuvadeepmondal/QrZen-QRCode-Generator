  ...
  return (
    <form className="grid gap-5" onSubmit={(e) => e.preventDefault()} aria-labelledby="controls-heading">
      <div className="grid gap-2">
        ...
        <textarea
          id="qr-text"
          className="w-full min-h-24 rounded-lg border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-emerald-500/50 transition-shadow"
        ...
        <p className="text-xs text-gray-500 dark:text-zinc-400">
          Tip: Keep content concise for best scan reliability.
        </p>
      </div>
          ...
          <div className="sm:col-span-3 grid gap-2">
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="inline-flex h-10 items-center gap-2 rounded-md border border-zinc-200 dark:border-zinc-800 px-3 text-sm hover:bg-zinc-50 dark:hover:bg-zinc-800/50 transition-colors"
              >
      ...
      <div className="flex flex-wrap items-center gap-2 pt-2">
        <button
          type="button"
          onClick={reset}
          className="inline-flex h-10 items-center justify-center rounded-md border border-zinc-200 dark:border-zinc-800 px-4 text-sm hover:bg-zinc-50 dark:hover:bg-zinc-800/50 transition-colors"
        >
          Reset
        </button>
      </div>
    ...
    <div className="grid gap-1">
      ...
      <div className="flex items-center gap-2">
        <input
          id={`${id}-color`}
          type="color"
          className="h-10 w-10 rounded-md border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 p-1"
          value={value}
