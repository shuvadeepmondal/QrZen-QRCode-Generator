...
import { QRProvider } from "../qr-context"
            ...
            <div className="relative grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              <div className="text-center lg:text-left">
                ...
                <h1 className="text-3xl sm:text-5xl font-bold tracking-tight">
                  Create beautiful <span className="bg-gradient-to-r from-emerald-600 to-teal-600 bg-clip-text text-transparent">QR codes</span> instantly
                </h1>
                <p className="mt-4 text-sm sm:text-base text-gray-600 dark:text-zinc-300 max-w-2xl mx-auto lg:mx-0">
                  Customize colors, margins, and error correction. Add a center logo, then export as crisp PNG or SVG.
                </p>
                <div className="mt-6 flex flex-col sm:flex-row items-center gap-3 justify-center lg:justify-start">
                  <a
                    href="/generator"
                    className="inline-flex h-11 items-center justify-center gap-2 rounded-md bg-emerald-600 px-5 text-white hover:bg-emerald-700 transition-colors w-full sm:w-auto"
                  >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="inline-flex h-11 items-center justify-center gap-2 rounded-md border border-zinc-200 dark:border-zinc-800 px-5 hover:bg-zinc-50 dark:hover:bg-zinc-800/50 transition-colors w-full sm:w-auto"
              ...
              <div className="order-first lg:order-none grid place-items-center">
                <div className="relative aspect-square w-full max-w-[320px] rounded-2xl border border-zinc-200 dark:border-zinc-800 bg-white/80 dark:bg-zinc-900/60 overflow-hidden shadow-sm">
                  <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_left,rgba(16,185,129,.15),transparent_60%)]" aria-hidden />
                  <img
                    src="/stylized-qr-code.png"
                    alt="Stylized QR code illustration"
                    className="absolute inset-0 m-auto h-[72%] w-[72%] object-contain animate-in fade-in zoom-in-50 duration-500"
                  />
